...
{
    public class ParameterCpp : Parameter
    {
        public ParameterCpp()
        {
        ...
        public override IModelType ModelType
        {
            get
            {
                ...
                return new DictionaryTypeCpp { ValueType = base.ModelType, CodeModel = base.ModelType.CodeModel, SupportsAdditionalProperties = false };
            }
            set
            {
