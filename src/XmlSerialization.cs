    ...
    public static class XmlSerialization
    {
        ...
        public static string GenerateDeserializer(CodeModel cm, IModelType modelType, string typeName = null)
        {
            ...
            if (modelType is DictionaryType)
                return $"{XmlDeserializationClass}.CreateDictionaryXmlDeserializer({GenerateDeserializer(cm, (modelType as DictionaryType).ValueType, (modelType as DictionaryType).ValueType.AsNullableType((modelType as DictionaryTypeCpp).IsNullable))})";
