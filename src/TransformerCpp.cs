...
{
    public class TransformerCpp : CodeModelTransformer<CodeModelCpp>
    {
        public override CodeModelCpp TransformCodeModel(CodeModel cs)
        {
            var codeModel = cs as CodeModelCpp;
