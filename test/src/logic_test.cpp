#include "LogicManagementClient.h"
#include "WorkFlowVersions.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  logic::LogicManagementClient client(requester, {});
  client.apiVersion = "2017-01-19";
  client.subscriptionId = subscription_id;

  auto result = co_await client.workflowVersions.List(logic_resource_group, logic_workflow_name, {}, headers);
