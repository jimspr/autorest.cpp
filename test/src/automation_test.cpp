#include "AutomationManagementClient.h"
#include "AutomationManagement.h"
#include "AutomationAccountOperations.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  automation::AutomationManagementClient client(requester, {});
  client.apiVersion = "2017-01-19";
  client.subscriptionId = subscription_id;

  automation::AutomationManagement x(requester, {});
  x.apiVersion = "2017-01-19";
  x.subscriptionId = subscription_id;

  automation::AutomationAccountOperations ops(x);

  auto result = co_await ops.List(headers);
