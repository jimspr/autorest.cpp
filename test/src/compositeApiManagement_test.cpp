#include "ApiManagementClient.h"
#include "ApiManagementServices.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  apim::ApiManagementClient client(requester, {});
  client.apiVersion = "2015-06-01";
  client.subscriptionId = subscription_id;

  apim::ApiManagementServices services(client);
  auto result = co_await services.List(headers);
