#include "AnalysisServicesManagementClient.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  analysisservices::AnalysisServicesManagementClient client(requester, {});
  client.apiVersion = "2017-07-14";
  client.subscriptionId = subscription_id;

  auto result = co_await client.servers.List(headers);
