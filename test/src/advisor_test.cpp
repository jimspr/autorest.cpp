#include "AdvisorManagementClient.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  advisor::AdvisorManagementClient client(requester, {});
  client.apiVersion = "2017-04-19-alpha";
  client.subscriptionId = subscription_id;

  auto result = co_await client.operations.List(headers);
