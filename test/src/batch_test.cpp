#include "BatchManagementClient.h"
#include "BatchAccountOperations.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  BatchManagement::BatchManagementClient client(requester, {});
  client.apiVersion = "2017-05-1";
  client.subscriptionId = subscription_id;

  BatchManagement::BatchAccountOperations ops(client);
