#include "AzureMLWebServicesManagementClient.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  webservices::AzureMLWebServicesManagementClient client(requester, {});
  client.apiVersion = "2017-01-19";
  client.subscriptionId = subscription_id;

  auto result = co_await client.webServices.ListByResourceGroup(resource_group, {}, headers);
