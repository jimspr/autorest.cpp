#include "AppInsightsManagementClient.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  appin::AppInsightsManagementClient client(requester, {});
  client.apiVersion = "2015-04-01";
  client.subscriptionId = subscription_id;

  appin::Operations operations(client);
  auto result = co_await operations.List(headers);
