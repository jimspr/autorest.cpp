#include "AuthorizationManagementClient.h"
...
future_t<void> test1(curl_requester_t& requester)
{
  ...
  authorization::AuthorizationManagementClient client(requester, {});
  client.apiVersion = "2015-06-01";
  client.subscriptionId = subscription_id;

  auto result = co_await client.classicAdministrators.List(client.apiVersion, headers);
